...
import type { NotionIntegration } from "@/types/notionIntegration"; // Import the type
...
function NotionIntegrationsPage() {
	...
	const deleteMutation = useMutation({
		...
		onError: (err: Error) => {
			toast({
				title: "Error",
				description: err.message || "Failed to delete Notion integration.",
				variant: "destructive",
			});
			setShowDeleteDialog(false);
			setSelectedIntegrationId(null);
		...
		<AppLayout>
			...
			<AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
				<AlertDialogContent>
					...
					<AlertDialogFooter>
						<AlertDialogCancel onClick={() => setSelectedIntegrationId(null)}>
							Cancel
						</AlertDialogCancel>
						<AlertDialogAction
