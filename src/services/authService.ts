 ...
 */
export const updateUserPassword = async (currentPassword_provided: string, newPassword_provided: string) => {
  ...
  try {
    const credential = EmailAuthProvider.credential(email, currentPassword_provided);
